...
public enum IAMError {
    ...
    API_CLIENT_FAIL(400, FAIL, HttpStatus.BAD_REQUEST),
    CRYPTO_ERROR(2000, ERROR, HttpStatus.INTERNAL_SERVER_ERROR),
    SERVICE_UNAVAILABLE(2001, ERROR, HttpStatus.INTERNAL_SERVER_ERROR),
    WRONG_CONFIGURATION(2002, ERROR, HttpStatus.INTERNAL_SERVER_ERROR),
    ;
